...
namespace Server.Services.Commands
{
    public class FindCommand : ICommand
    {
        ...
        private void FindStaff()
        {
            ...
            if (_enterData != null && findStaff.SecurityLevel < _database.Users.FirstOrDefault(u => u.Id == _enterData.intId).SecurityLevel)
        ...
        private void FindTask()
        {
            ...
            foreach (Task task in allTasks)
            {
                ...
                if (_enterData != null)
                {
                    User enterStaff = _database.Users.FirstOrDefault(u => u.Id == _enterData.intId);
